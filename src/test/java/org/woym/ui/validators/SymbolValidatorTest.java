...
public class SymbolValidatorTest {
	...
	public void testSymbolInuse() throws DatasetException {
		...
		PowerMockito.when(teacherDAO.getBySymbol(Mockito.anyString())).thenReturn(teacherList);
	...
	public void testSymbolNotInuse() throws DatasetException {
		PowerMockito.when(teacherDAO.getBySymbol(Mockito.anyString())).thenReturn(new ArrayList<Teacher>());
